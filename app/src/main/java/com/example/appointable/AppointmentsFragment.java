...
public class AppointmentsFragment extends Fragment {
    ...
    // Current status filter: "All", "Pending", "Canceled", "Rescheduled", "Completed"
    ...
    private void loadAppointments() {
        ...
        db.collection("appointments")
                ...
                .addOnSuccessListener(query -> {
                    ...
                    // Apply whatever filter is active (default = "All")
                    applyStatusFilter();
    ...
    private void applyStatusFilter() {
        ...
        if ("All".equalsIgnoreCase(currentStatusFilter)) {
            ...
            for (Appointment a : allAppointments) {
                if (a.getStatus() != null &&
                        a.getStatus().equalsIgnoreCase(currentStatusFilter)) {
    ...
    private void highlightSelectedStatus() {
        ...
        // Dim the selected one a bit (or you can invert this logic if you like)
    ...
    private void showAddAppointmentDialog() {
        ...
        btnSave.setOnClickListener(v -> {
            ...
            if (pos < 0) {
                Toast.makeText(getContext(), "Pick a teacher", Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    private void showRescheduleDialog(Appointment appt) {
        ...
        EditText etComment = view.findViewById(R.id.etComment); // <-- new
        ...
        dialog.setOnShowListener(dlg -> {
            dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(v -> {
                ...
                String comment = etComment.getText().toString().trim(); // <-- read comment
    ...
    private void updateReschedule(Appointment appt, String newDate, String newTime, String comment) {
        FirebaseFirestore.getInstance()
                ...
                .update(
                        ...
                        "time", newTime,
                        "status", "Rescheduled",
                        "rescheduleComment", comment   // new field in Firestore
                )
                .addOnSuccessListener(a -> loadAppointments());
    }
