...
import com.example.appointable.adapters.ChatMessagesAdapter;
...
public class Chat_TeacherFragment extends Fragment {
    ...
    public static Chat_TeacherFragment newInstance(String otherUid,
                                                   String otherName,
                                                   @Nullable String firstMessage) {
        Chat_TeacherFragment fragment = new Chat_TeacherFragment();
    ...
    private void closeChat() {
        ((TeachersMainActivity) requireActivity()).showBottomNav();
        hideKeyboard();
